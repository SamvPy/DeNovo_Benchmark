...
def main(args):
    if args.file_type == "file":
        ...
        for file_path in tqdm(
            glob(args.mgf_folder + "/*.mgf"), desc="Filtering mgf-files..."
        ):
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "-o", "--output_folder", required=True, help="Output folder to store mgf files"
    )
    ...
    parser.add_argument(
        ...
        "--max_charge",
        default=8,
        help="Filter out spectra in mgf with charges higher than -c",
    )
